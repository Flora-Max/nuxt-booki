<template>
    <article>
        ...
        <div class="cards-list__item__content">
            <header class="cards-list__item__header">
                <h3 class="cards-list__item__title">{{ content.name }} {{ content.id }}</h3>
            </header>
            <p>
            ...
            <p>
               <span>Nuit à partir de {{ content.price }}€</span>
            </p>
    ...
    <!--
          ...
          <nuxt-link :to="{ name: 'reservations-id' }">Reserver</nuxt-link>
        </div>
      </article>
</template>
